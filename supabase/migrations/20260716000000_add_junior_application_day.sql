...
ADD COLUMN IF NOT EXISTS application_day text;

CREATE OR REPLACE FUNCTION public.register_junior(junior_usage_type smallint, p_application_day text DEFAULT NULL)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
